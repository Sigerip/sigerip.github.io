...
```{ojs}
html`<p><a href="metodologia.html#banco-de-dados-de-mortalidade-geral-e-t%C3%A1buas-de-vida">Metodologia do banco de dados e tábuas de vida.</a></p>`
```