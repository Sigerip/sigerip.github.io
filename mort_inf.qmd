...
dadosOriginais = FileAttachment("dados/mortalidade_infantil/mort_infantil.csv").csv({typed: true})
...
```{ojs}
html`<p><a href="metodologia.html#banco-de-dados-de-mortalidade-infantil">Metodologia da mortalidade infantil</a>.</p>`
```
