...
```{ojs}
// Dados e filtros
prev_comb = await FileAttachment('dados/arima-ets/previsoes_combinado.csv').csv()
...
<body>
    ...
    <a href="dados/arima-ets/previsoes_combinado.csv" download>
        ARIMA+ETS.
    </a>
    </p>
...
erros2 = await FileAttachment("dados/arima-ets/metricas_erro_combinado.csv").csv({typed: true})
//modelos = ["ARIMA+ETS", "Lee-Carter", "Lee-Miller"]
//regioes2 = [...new Set(erros.map(d => d.regiao))].sort()
//anos2 = [...new Set(erros.map(d => d.ano))].sort()


/*erro = erros.filter(d => d.regiao === regiao2 && d.taxa === sexo2 && +d.ano === ano4)
  .map(d => ({
  faixa: d.faixa_etaria,
