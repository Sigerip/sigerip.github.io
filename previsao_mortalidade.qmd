...
```{ojs}
// Dados e filtros
prev_comb = await FileAttachment('dados/dados1/previsao_concatenados.csv').csv()
...
<body>
    ...
    <a href="dados/dados1/previsao_concatenados.csv" download>
        ARIMA+ETS.
    </a>
    </p>
...
erros2 = await FileAttachment("dados/dados1/erros_concatenados.csv").csv({typed: true})
