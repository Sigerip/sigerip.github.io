...
<section id="lee-carter">
    ...
    <p>Para validar a acurácia das projeções, calcularam-se RMSE (erro quadrático médio), MAE (erro absoluto médio) e sMAPE (erro percentual absoluto médio simétrico) para comparar valores observados e projetados.</p>
...
<section id="hibrido">
    ...
    <p>Foram calculados: RMSE (erro quadrático médio), MAE (erro absoluto médio) e sMAPE (erro percentual absoluto simétrico).</p>
