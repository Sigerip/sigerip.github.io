...
```{ojs}
d3 = require("d3@7")
tabua_comb = await FileAttachment("dados/arima-ets/tabuas_combinado.csv").csv()
tabua_lm = await FileAttachment("dados/lc-lm/tabua_lm.csv").csv()
tabua_lc = await FileAttachment("dados/lc-lm/tabua_lc.csv").csv()
regiao1 = ["Brasil", "Centro-Oeste", "Nordeste", "Norte", "Sudeste", "Sul", "Acre", "Alagoas", "Amapá", "Amazonas", "Bahia", "Ceará", "Distrito Federal", "Espírito Santo", "Goiás", "Maranhão", "Mato Grosso", "Mato Grosso do Sul", "Minas Gerais", "Pará", "Paraíba", "Paraná", "Pernambuco", "Piauí", "Rio de Janeiro", "Rio Grande do Norte", "Rio Grande do Sul", "Rondônia", "Roraima", "Santa Catarina", "São Paulo", "Sergipe", "Tocantins"];
...
{  
  if (modelo.includes("ARIMA+ETS")) {
    return html`<p>Para acessar a metodologia utilizada no modelo combinado ARIMA com ETS, <a href="metodologia.html#modelo-lee-carter">clique aqui</a>.</p>`;
  }
  else if (modelo.includes("Lee-Miller")) {
    ...
    html`<p>Para acessar a metodologia utilizada no modelo Lee-Carter, <a href="metodologia.html#modelo-lee-carter">clique aqui</a>.</p>`;
  }
}
```
...
<body>
    ...
    <a href="dados/arima-ets/tabuas_combinado.csv" download>
        ARIMA+ETS.
    </a>
    </p>
</body>
...
<body>
    ...
    <a href="dados/lc-lm/tabua_lm.csv" download>
        Lee-Miller.
    </a>
    </p>
</body>
...
<body>
    <br>
    <p>Baixar tábua de previsão do modelo 
    <a href="dados/lc-lm/tabua_lc.csv" download>
        Lee-Carter.
    </a>
    </p>
</body>
