---
title: Previsão da expectativa de vida
execute: 
  echo: false
  panel: sidebar
---
...
```{ojs}
d3 = require("d3@7")
tabua_comb = await FileAttachment("dados/arima-ets/tabuas_combinad.csv").csv()
...
<body>
    ...
    <a href="dados/arima-ets/tabua_comb.csv" download>
        ARIMA+ETS.
    </a>
    </p>
</body>
